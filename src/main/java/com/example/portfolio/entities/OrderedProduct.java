...
@NamedQueries({
    ...
    , @NamedQuery(name = "OrderedProduct.findByProductCode", query = "SELECT o FROM OrderedProduct o WHERE o.orderedProductPK.productCode = :productCode")
...
public class OrderedProduct implements Serializable {
    ...
    public OrderedProduct(int customerOrderId, int productCode) {
        this.orderedProductPK = new OrderedProductPK(customerOrderId, productCode);
    }
    ...
    public String toString() {
        return "com.example.portfolio.entities.OrderedProduct[ orderedProductPK=" + orderedProductPK + " ]";
    }
